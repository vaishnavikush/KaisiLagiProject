...
public class UserController {
    ...
    public String editProfile(Model model, HttpSession session) {
        ...
        // Photo and username are now added globally
        return "editProfile";
    }
    ...
    public String login(@RequestParam String email,
        ...
        // User not found - redirect with error parameter
        if (user == null) {
            return "redirect:/login?error=usernotfound";
        }

        // Wrong password - redirect with error parameter
    ...
    public String register(@RequestParam String email,
        ...
        // Email already exists - redirect with error parameter
        if (userRepository.findByEmail(email) != null) {
            return "redirect:/login?register=emailexists";
        }

        // Password validation
        if (password == null || password.isBlank()) {
            return "redirect:/login?register=emptypassword";
        }

        // Passwords don't match (if confirmPassword is provided from form)
        if (confirmPassword != null && !password.equals(confirmPassword)) {
            return "redirect:/login?register=passwordmismatch";
        }
